...
/**
  * @desc declare a room and its components
  * @param char*desc - description for the room
  * @param char*tool - required Item to beat the challenge
  * @param Item*item_list - pointer to Item LinkedList in the room
  * @param bool blocked - determine if room is accessible
  * @param chamber* north - pointer north room
  * @param chamber* south - pointer south room
  * @param chamber* east - pointer east room
  * @param chamber* west - pointer west room
  * @param chamber* up - pointer upper room
  * @param chamber* down - pointer below room
...
/**
  * @desc check if a LinkedList contains this Item
  * @param char* search - choosen Item
  * @param Item* curr_room - LinkedList need to be searched
*/
...
/**
  * @desc add effect when using Item and alter the room state
